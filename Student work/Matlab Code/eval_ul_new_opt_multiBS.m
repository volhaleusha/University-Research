...
for d = 4; %:maxNodes
   ...
   %percentage of simultion finished 
    for i = 1:drops
...
%        t5(i) = toc;
       ...
       % Repeat random m times and take the best value from all values
       opt_common_old=0;
       ...
       win_Gr = get_winner(optGr_LTE,optRand_LTE,optMaxReg_LTE,optMaxRegUser_LTE);
       win_Rand = get_winner(optRand_LTE,optGr_LTE,optMaxReg_LTE,optMaxRegUser_LTE);
       win_MaxReg = get_winner(optMaxReg_LTE,optRand_LTE,optGr_LTE,optMaxRegUser_LTE);
...
%        
       winner_Gr_d_i(i)= winner_Gr_d;
       winner_Rand_d_i(i)= winner_Rand_d;
       winner_MaxReg_d_i(i)=winner_MaxReg_d;
       winner_MaxRegUser_d_i(i)=winner_MaxRegUser_d;
...
w = [winner_Gr_d,winner_Rand_d,winner_MaxReg_d, winner_MaxRegUser_d]
plot(1:drops,winner_Gr_d_i,1:drops,winner_Rand_d_i,1:drops, winner_MaxReg_d_i, 1:drops,  winner_MaxRegUser_d_i)
